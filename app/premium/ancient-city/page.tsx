    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <header className="mb-10">
        ...
        <div className="flex flex-wrap gap-3 mt-3 text-xs font-mono text-stone-400">
          <span>12 episodes</span><span>~45 minutes</span><span>$0.99</span>
        </div>
      ...
      <div className="mb-6 p-4 rounded-lg bg-amber-50 border-2 border-amber-300 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-amber-700">Buy any guide above and get this Ancient City tour free. Or buy it standalone for <strong>$0.99</strong>.</p>
        </div>
      </div>
