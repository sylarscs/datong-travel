...
const EPISODES = [
  ...
  { num: 7, title: "Shanhua Temple — The Quiet Masterpiece", duration: "3 min", highlight: true, badge: "Must See", desc: "Free, uncrowded, 1,200 years old. Jin Dynasty Buddhas with portrait-like faces. Liao Dynasty murals most visitors never see." },
  ...
  { num: 9, title: "Dongnan Yi — The Old Merchant Quarter", duration: "2 min", highlight: false, desc: "Coal Market Street, Silk Alley, and the courtyards of Datong's old merchant families. The commercial soul of the Ming Dynasty frontier." },
