...
const EPISODES = [
  ...
  { num: 6, title: "Why This Matters", duration: "2 min", desc: "Proof that nomadic people built permanent things. The greatest monuments aren't always in the famous places." },
];
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <header className="mb-10">
        ...
        <div className="flex flex-wrap gap-3 mt-3 text-xs font-mono text-stone-400">
          <span>6 episodes</span><span>~20 minutes</span><span>$3.99</span>
        </div>
