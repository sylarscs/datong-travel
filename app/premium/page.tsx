...
export const metadata = {
  ...
  description: "Premium English audio guides for Yungang Grottoes, Hanging Temple, Huayan Temple, Yingxian Wooden Pagoda, and Datong Ancient City. Bundle all 5 and save 31%.",
};
...
const GUIDES = [
  ...
  },
  {
    ...
    price: "$5.99", image: "",
    desc: "A full-day walking tour: 12 attractions across 3.28 sq km — temples, mosques, churches, markets, and the city wall at sunset.",
  },
];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="p-6 sm:p-8 rounded-xl bg-stone-900 text-white text-center mb-8">
        <p className="text-xs font-semibold uppercase tracking-wider text-stone-400 mb-2">Best Value — 69折</p>
        ...
        <p className="font-display font-bold text-3xl mb-1">$21.99</p>
