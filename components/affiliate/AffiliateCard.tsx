  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h4 className="font-semibold text-stone-900 group-hover:text-red-800 transition-colors">
          {title}
        </h4>
      ...
      <span className="flex-shrink-0 inline-flex items-center px-3 py-1.5 rounded-md bg-red-800 text-white text-sm font-semibold group-hover:bg-red-900 transition-colors">
        {typeLabel[type]} →
      </span>
    </a>
  );
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <span className="text-sm font-semibold text-red-800 group-hover:translate-x-0.5 transition-transform">
            Check Availability →
          </span>
        </div>
      </div>
...
export function AffiliateTicketCard({
  ...
  return (
    <a
      ...
      className="group flex items-center justify-between p-4 rounded-lg border border-stone-200 bg-white hover:border-red-800/20 hover:shadow-sm transition-all duration-200"
    >
      <div>
        <h4 className="font-semibold text-stone-900 group-hover:text-red-800 transition-colors">
          {name}
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        ...
        <span className="px-3 py-1.5 rounded-md bg-red-800 text-white text-sm font-semibold group-hover:bg-red-900 transition-colors">
          Book →
        </span>
      </div>
    </a>
